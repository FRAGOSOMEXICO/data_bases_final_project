 ...
 * @author biosh
 */
public class Decide_si_descendente_alfabetico extends javax.swing.JFrame {

    /**
     * Creates new form Decide_si_descendente_alfabetico
     */
    public Decide_si_descendente_alfabetico() {
    ...
    private void initComponents() {
        ...
        jButton1.setActionCommand("Descendente");
        ...
        jLabel1.setText("¿Como desea rodenar los nombres?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Decide_si_descendente_alfabetico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Decide_si_descendente_alfabetico().setVisible(true);
            }
        });
    }
